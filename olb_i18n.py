...
MESSAGES: dict[str, dict[str, str]] = {
    "en": {
        ...
        "version_arg_help": "print the installed version",
        ...
        "cmd_doctor_help": "inspect local bridge setup without making changes",
        ...
        "cmd_start_help": "enable the environment and start the bridge in background by default",
        "cmd_restart_help": "restart the bridge and keep the current mode by default",
        "cmd_reload_help": "restart the bridge and keep the current mode by default",
        "cmd_log_help": "follow the bridge log; show the latest 10 lines first",
        "start_debug_help": "run bridge in foreground with live output",
        "doctor_title": "OpenAI Local Bridge Doctor",
        "doctor_column_check": "Check",
        "doctor_column_status": "Status",
        "doctor_column_detail": "Detail",
        "doctor_status_ok": "ok",
        "doctor_status_warn": "warning",
        "doctor_status_fail": "failed",
        "doctor_check_config": "Config file",
        "doctor_check_active_account": "Active account",
        "doctor_check_openssl": "OpenSSL",
        "doctor_check_status": "Status checks",
        "doctor_check_root_ca": "Root CA",
        "doctor_check_hosts": "Hosts mapping",
        "doctor_check_nss": "NSS trust",
        "doctor_check_listener": "Listener",
        "doctor_config_ok": "found: {path}",
        "doctor_config_missing": "missing: {path}",
        "doctor_config_invalid": "invalid config: {detail}",
        "doctor_account_ok": "active account: {name}",
        "doctor_account_missing": "no active account configured",
        "doctor_account_incomplete": "account {name} missing: {fields}",
        "doctor_openssl_ok": "found: {path}",
        "doctor_openssl_missing": "missing command: openssl",
        "doctor_status_error": "could not inspect status: {detail}",
        "doctor_root_ca_ok": "found: {path}",
        "doctor_root_ca_missing": "missing; run `olb enable` or `olb start`",
        "doctor_hosts_enabled": "enabled in {path}",
        "doctor_hosts_disabled": "not enabled in {path}",
        "doctor_nss_ok": "{state}",
        "doctor_nss_warn": "{state}; run `olb enable` if browsers need NSS trust",
        "doctor_listener_ok": "listening on {addr}",
        "doctor_listener_stopped": "not listening on {addr}",
        "doctor_ok": "doctor checks passed",
        "doctor_failed": "doctor found {count} failed check(s)",
        ...
        "bridge_log_missing": "bridge log does not exist yet: {log_path}",
    ...
    "zh": {
        ...
        "cmd_doctor_help": "只检查本地 bridge 配置，不修改系统",
        ...
        "cmd_start_help": "启用环境并启动 bridge，默认后台运行",
        "cmd_restart_help": "重启 bridge，默认保持当前运行模式",
        "cmd_reload_help": "重启 bridge，默认保持当前运行模式",
        "cmd_log_help": "实时查看 bridge 日志，启动时先显示最新 10 行",
        "start_debug_help": "以前台模式运行 bridge 并输出实时日志",
        "doctor_title": "OpenAI Local Bridge 体检",
        "doctor_column_check": "检查项",
        "doctor_column_status": "状态",
        "doctor_column_detail": "详情",
        "doctor_status_ok": "正常",
        "doctor_status_warn": "警告",
        "doctor_status_fail": "失败",
        "doctor_check_config": "配置文件",
        "doctor_check_active_account": "当前账号",
        "doctor_check_openssl": "OpenSSL",
        "doctor_check_status": "状态检查",
        "doctor_check_root_ca": "根证书",
        "doctor_check_hosts": "Hosts 映射",
        "doctor_check_nss": "NSS 信任",
        "doctor_check_listener": "监听",
        "doctor_config_ok": "已找到：{path}",
        "doctor_config_missing": "缺失：{path}",
        "doctor_config_invalid": "配置不合法：{detail}",
        "doctor_account_ok": "当前账号：{name}",
        "doctor_account_missing": "未配置当前账号",
        "doctor_account_incomplete": "账号 {name} 缺少：{fields}",
        "doctor_openssl_ok": "已找到：{path}",
        "doctor_openssl_missing": "缺少命令：openssl",
        "doctor_status_error": "无法检查状态：{detail}",
        "doctor_root_ca_ok": "已找到：{path}",
        "doctor_root_ca_missing": "缺失；请执行 `olb enable` 或 `olb start`",
        "doctor_hosts_enabled": "已在 {path} 启用",
        "doctor_hosts_disabled": "未在 {path} 启用",
        "doctor_nss_ok": "{state}",
        "doctor_nss_warn": "{state}；如果浏览器需要 NSS 信任，请执行 `olb enable`",
        "doctor_listener_ok": "正在监听 {addr}",
        "doctor_listener_stopped": "未监听 {addr}",
        "doctor_ok": "doctor 检查通过",
        "doctor_failed": "doctor 发现 {count} 个失败检查",
        ...
        "bridge_log_missing": "bridge 日志文件还不存在：{log_path}",
